...
extension ResetViewController{
    private func layout(){
        ...
        verticalStack.addArrangedSubview(criteria)
        ...
        NSLayoutConstraint.activate([
            ...
            verticalStack.leadingAnchor.constraint(equalToSystemSpacingAfter: view.safeAreaLayoutGuide.leadingAnchor, multiplier: 1),
            view.safeAreaLayoutGuide.trailingAnchor.constraint(equalToSystemSpacingAfter: verticalStack.trailingAnchor, multiplier: 1)
        ]);
    }
    private func setup(){
