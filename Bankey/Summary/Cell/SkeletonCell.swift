...
//            nameLabel.trailingAnchor.constraint(equalToSystemSpacingAfter: balanceStackView.leadingAnchor, multiplier: 1),
...
extension SkeletonCell{
    func configure(with vm: SummaryModel){
        ...
        switch vm.type{
            case .Banking:
            underlineView.backgroundColor = appColor;
            balanceAmountLabel.text = "Current balance";
                break;
            case .CreditCard:
